...
def get_inputs():
    ...
    input_data = [[loan_amnt, term, int_rate, emp_length, home_ownership, annual_inc, verification_status, purpose, dti, inq_last_6mths, open_acc, revol_bal, revol_util, initial_list_status, total_rec_int, last_week_pay, tot_cur_bal]]
    input_df = pd.DataFrame(input_data, columns=['loan_amnt', 'term', 'int_rate', 'emp_length', 'home_ownership', 'annual_inc', 'verification_status', 'purpose', 'dti', 'inq_last_6mths', 'open_acc', 'revol_bal', 'revol_util', 'initial_list_status', 'total_rec_int', 'last_week_pay', 'tot_cur_bal'])
